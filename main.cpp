...
public:
    void readCustomer()
    {
        ...
        if (file.is_open() && ifs.tellg() != 0)
        {
            ...
            {
                cout << c.name << "\t" << c.id << "\t";
                if (c.typeOfRoom == 's' || c.typeOfRoom == 'S')
                    cout << "Single\t\t";
                else if (c.typeOfRoom == 'd' || c.typeOfRoom == 'D')
                    cout << "Double\t\t";
                cout << c.numOfDays << "\n";
                file.read((char *)&c, sizeof(c));
            }
    ...
    void writeCustomer()
    {
        ...
        do
        {
            ...
            cout << "Enter your Id: ";
            cin >> c.id;
            cout << "Do you want single room or double ? (S/D): ";
            cin >> c.typeOfRoom;
    ...
    void updateCustomer()
    {
        ...
        bool found = false;
        int x;
        cout << "Enter Id Of Customer to update number of days booked: ";
        cin >> x;
        if (file.is_open() && ifs.tellg() != 0)
        {
            file.read((char *)&c, sizeof(c));
...
public:
    void writeRoom()
    {
        ...
        do
        {
            ...
            cout << "\nRoom Number: ";
            cin >> r.room_no;
            cout << "Room Type 'S' for Single 'D' for Double (S/D): ";
            cin >> r.room_type;
            ...
            cout << "Room View 'S' for Sea and 'P' for Pool and 'G' Garden: ";
            cin >> r.room_view;
    ...
    void readRoom()
    {
        ...
        if (in.is_open() && ifs.tellg() != 0)
        {
            ...
            {
                cout << r.room_no << "\t";
                if (r.room_type == 's' || r.room_type == 'S')
                    cout << "Single\t";
                else if (r.room_type == 'd' || r.room_type == 'D')
                    cout << "Double\t";
                if (r.room_view == 'S' || r.room_view == 's')
                    cout << "Sea\t";
                else if (r.room_view == 'P' || r.room_view == 'p')
                    cout << "Pool\t";
                else if (r.room_view == 'G' || r.room_view == 'g')
                    cout << "Garden\t";
                cout << r.room_price << "\n";
                in.read((char *)&r, sizeof(r));
            }
